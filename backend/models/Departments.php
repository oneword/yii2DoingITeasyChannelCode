 ...
 * @property string $department_create_data
...
class Departments extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['branches_branch_id', 'department_name', 'companies_company_id', 'department_create_data', 'department_status'], 'required'],
            [['branches_branch_id', 'companies_company_id'], 'integer'],
            [['department_create_data'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'department_create_data' => 'Department Create Data',
